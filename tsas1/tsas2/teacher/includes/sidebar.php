        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="tcdash.php" ><i class="ti-home"></i>Dashboard</a></li>
                   
                    <li><a href="basicdet.php"><i class="ti-files"></i>Basic Details</a></li>
                    <li><a href="contactdet.php"><i class="ti-files"></i>Contact Details</a></li>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-user"></i>Records<span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="manage-teacher.php">Teacher Accounts</a></li>

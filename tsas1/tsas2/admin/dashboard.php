...
?>
                                        <h4 style="color: blue">Regular Teachers</h4>
...
?>
                                        <h4 style="color: blue">Part Time Teachers</h4>
...
?>
                                       <h4 style="color: blue">Temporary Teachers</h4>
...
$totteacher=$query3->rowCount();
?>
                                       <h4 style="color: blue">Approved</h4>
                                         <h4 style="color: blue"><?php echo htmlentities($totteacher);?></h4>
                                        <!--  <a href="manage-teacher.php"><h5>View Detail</h5></a> -->
                                    </div>
                                </div>
...
$totteacher=$query3->rowCount();
?>
                                       <h4 style="color: blue">Inapproved</h4>
                                         <h4 style="color: blue"><?php echo htmlentities($totteacher);?></h4>
                                        <!--  <a href="manage-teacher.php"><h5>View Detail</h5></a> -->
                                    </div>
                                </div>
...
<script>
var xValues = ["Blank", "Blank", "Blank", "Blank", "Blank"];
